...
@SeeAlso({org.apache.nifi.processors.standard.QueryDatabaseTable.class, org.apache.nifi.processors.standard.ExecuteSQL.class, org.apache.nifi.processors.standard.ListDatabaseTables.class})
...
public class GenerateCustomTableFetch extends AbstractDatabaseFetchProcessor {
    ...
    public GenerateCustomTableFetch() {
        ...
        try {
            ...
            try (final Connection con = dbcpService.getConnection(finalFileToProcess == null ? Collections.emptyMap() : finalFileToProcess.getAttributes());
                ...
                for (long i = 0; i < numberOfFetches; i++) {
                    ...
                    sqlFlowFile = session.putAttribute(sqlFlowFile, "generatetablefetch.numberOfFetches", String.valueOf(numberOfFetches));
                    // ####################################################################################################################
                    if (columnNames != null) {
